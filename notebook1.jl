...
## Barreau de silice dans l'air
Calcul des modes vectoriels d'un barreau de silice (n=1,45) de diamètre 2a=1,5 µm dans l'air (n=1) pour une longueur d'onde de 1 µm.
"""
...
md"Valeur de $\mu$ (numéro du mode) :"
...
#Vecteur position pour représentation graphique
x=a*(-3:0.05:3);
...
md"""
## Exercice : Fibre multicouche
Effectuer le calcul du mode vectoriel fondamental pour une fibre en anneau à la longueur d'onde 1.55 µm :
- Coeur de rayon 3 µm et d'indice 1.4
- Un anneau d'épaisseur 1 µm et d'indice 1.5
- La gaine d'indice 1.2
"""
...
md"""
## Exercice : Approximation de faible guidage
Une fibre à saut d'indice possède un coeur de diamètre 2 µm et d'indice 1.47 et une gaine d'indice 1.45.\
A la longueur d'onde de 1 µm, la fibre est bimodale (V=3).\
Calculer les indices effectifs de tous les modes LP ainsi que de tous les modes vectoriels guidés par cette fibre et vérifier que les modes vectoriels sont quasi-dégénérés en modes LP.
"""
